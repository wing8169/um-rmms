  ...
  e.prototype = {
    ...
    lookup: function(e) {
      ...
      clearTimeout(this.lookupWorker),
        (this.lookupWorker = setTimeout(s, this.delay));
    },
    process: function(e) {
      var s = this;
      return (
        ...
        t.each(e, function(t, s) {
          t > 0 && s[h] !== e[t - 1][h] && n.push({ __type: "divider" }),
            this.showCategoryHeader &&
              (!s[h] ||
                (0 !== t && s[h] === e[t - 1][h]) ||
                n.push({ __type: "category", name: s[h] })),
            n.push(s);
        }),
        (e = t(n).map(function(e, n) {
          if ("category" == (n.__type || !1))
            return t(s.options.headerHtml || s.theme.headerHtml).text(
              n.name
            )[0];
          if ("divider" == (n.__type || !1))
            return t(s.options.headerDivider || s.theme.headerDivider)[0];
          var h = i.displayText(n);
          return (
            (e = t(s.options.item || s.theme.item).data("value", n))
              .find(
                s.options.itemContentSelector || s.theme.itemContentSelector
              )
              .addBack(
                s.options.itemContentSelector || s.theme.itemContentSelector
              )
              .html(s.highlighter(h, n)),
            s.options.followLinkOnSelect &&
              e.find("a").attr("href", i.itemLink(n)),
            e.find("a").attr("title", i.itemTitle(n)),
            h == i.$element.val() &&
              (e.addClass("active"), i.$element.data("active", n), (o = !0)),
            e[0]
          );
        })),
        this.autoSelect &&
    ...
    keydown: function(e) {
      17 !== e.keyCode &&
        ((this.keyPressed = !0),
        (this.suppressKeyPressRepeat = ~t.inArray(e.keyCode, [
          40,
          38,
          9,
          13,
      ...
      : this.each(function() {
          ...
          n || o.data("typeahead", (n = new e(this, h))),
            "string" == typeof s &&
              n[s] &&
              (i.length > 1
                ? n[s].apply(n, Array.prototype.slice.call(i, 1))
                : n[s]());
        });
  }),
    (e.defaults = {
